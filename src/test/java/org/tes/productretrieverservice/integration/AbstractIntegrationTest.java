...
public abstract class AbstractIntegrationTest extends TestFactory {
    ...
    protected void performDeleteRequest(
            String path,
            ResultMatcher expectedStatus
    )
            throws Exception {
    ...
    protected void performDeleteRequestExpectedSuccess(String path)
            throws Exception {
    ...
    protected void performDeleteRequestExpectedServerError(String path)
            throws Exception {
        performDeleteRequest(
                path,
                status().is5xxServerError()
